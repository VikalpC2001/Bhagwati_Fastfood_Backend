    ...
    try {
        ...
        pool.query(sql_querry_getCountdetails, (err, rows, fields) => {
            if (err) {
                ...
                const commonQuery = `SELECT stockOutId, user_details.userName AS outBy, CONCAT(user_details.userFirstName,' ',user_details.userLastName) AS userName,inventory_product_data.productName AS productName, CONCAT(productQty,' ',productUnit) AS Quantity, ROUND(stockOutPrice) AS stockOutPrice, inventory_stockOutCategory_data.stockOutCategoryName AS stockOutCategoryName, stockOutComment, CONCAT(DATE_FORMAT(stockOutDate,'%d-%m-%Y'),' ',DATE_FORMAT(stockOutCreationDate, '%h:%i %p')) AS stockOutDate 
