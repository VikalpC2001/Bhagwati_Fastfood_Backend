    ...
    try {
        upload(req, res, async (err) => {
            ...
            const data = {
                ...
                employeeOtherMobileNumber: req.body.employeeOtherMobileNumber ? req.body.employeeOtherMobileNumber.trim() : null,
                presentAddress: req.body.presentAddress.trim(),
                homeAddress: req.body.homeAddress.trim(),
                adharCardNum: req.body.adharCardNum ? req.body.adharCardNum.trim() : null,
