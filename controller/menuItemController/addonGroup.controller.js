    ...
    try {
        ...
        pool.query(sql_querry_getCountDetails, (err, rows, fields) => {
            if (err) {
                ...
                const sql_query_getDetails = `SELECT groupId, groupName FROM item_addonsGroup_data LIMIT ${limit}`;
                ...
                if (!data.groupName) {
                    ...
                    pool.query(`SELECT groupName FROM item_addonsGroup_data WHERE groupName = '${data.groupName}'`, function (err, row) {
                        ...
                        if (row && row.length) {
                            ...
                            const sql_querry_addCategory = `INSERT INTO item_addonsGroup_data (groupId, groupName)  
                                                            VALUES ('${groupId}','${data.groupName}')`;
...
const updateAddOnsGroupData = async (req, res) => {
    try {
        ...
        const sql_querry_updatedetails = `UPDATE item_addonsGroup_data SET groupName = '${data.groupName}'
